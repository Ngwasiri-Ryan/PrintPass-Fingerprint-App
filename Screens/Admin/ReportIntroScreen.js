...
const ReportIntroScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Generate Attendance Reports</Text>
      <View style={styles.imageContainer}>
        <Image source={images.report_pic} style={styles.image} />
      </View>
      <View style={styles.buttonContainer}>
        <Animated.View style={[styles.animatedButtonWrapper, { transform: [{ scale: scaleAnim }] }]}>
          <TouchableOpacity
            onPress={() => navigation.navigate("ReportGeneratorScreen")}
            style={styles.button}
          >
